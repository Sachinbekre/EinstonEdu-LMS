...
import { CHANGELEFTMENUBAR } from '../actions/actions';

export interface LeftMenuBarInterface {
    menuList: any;
}

export const INITIAL_STATE_LEFTMENUBAR: LeftMenuBarInterface = {
    menuList: [
        {
          name: 'Dashboard',
          url: '/dashboard',
...
export function sideMenuBarReducer(state: LeftMenuBarInterface = INITIAL_STATE_LEFTMENUBAR, action): LeftMenuBarInterface {
    switch (action.type) {
        case CHANGELEFTMENUBAR:
            // console.log('Changed');
            const om = Object.assign({}, state, {
